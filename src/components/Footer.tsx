...
import { SlideInGroup } from './ScrollAnimation';
...
const Footer = () => {
  ...
  return (
    <footer>
      <SlideInGroup
        direction="right"
        className="grid md:grid-cols-2 lg:grid-cols-3 p-5 lg:mx-5 bg-brand-black/95 text-brand-white md:gap-x-5 lg:gap-x-10 gap-y-5"
      >
        <div className="flex flex-col gap-5">
          ...
          <Paragraph className="text-justify">
            ...
            for corporate needs since 2008. We are renowned professinals of
